...
if ($path ){
    ...
    try {
        ...
        $stmt = $db->prepare("SELECT * FROM PasteContent WHERE url = ?");
...
<div>id: <?= htmlspecialchars($snippet['snippet_id']) ?></div>
    ...
    <div id="content" name="text" style="display: none;"><?= htmlspecialchars($snippet['content']) ?></div>
</div>
